...
class SensitiveDataDetector:
    ...
    def __init__(self) -> None:
        ...
        self._sensitivity_hierarchy = {"CRITICAL": 4, "HIGH": 3, "MEDIUM": 2, "LOW": 1, "NONE": 0}
    ...
    def _generate_recommendations(self, matches: List[SensitiveMatch]) -> List[str]:
        ...
        for data_type, type_matches in by_type.items():
            ...
            recommendations.extend(self._get_recommendations_for_type(data_type, count))
        ...
        if total_high > 0:
            recommendations.append(f"Se detectaron {total_high} datos de alta sensibilidad que deben ser protegidos")
