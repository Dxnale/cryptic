...
from cryptic.core.hash_identifier import HashAnalysis, HashIdentifier
from cryptic.core.sensitive_detector import SensitiveAnalysis, SensitiveDataDetector
...
class CrypticAnalyzer:
    ...
    def analyze_data(self, data: str) -> DataAnalysis:
        ...
        recommendations = self._generate_combined_recommendations(hash_analysis, sensitive_analysis, protection_status)
    ...
    def _determine_sensitivity_level(
        self, hash_analysis: HashAnalysis, sensitive_analysis: SensitiveAnalysis
    ) -> DataSensitivity:
        """
    ...
    def _determine_protection_status(
        self, hash_analysis: HashAnalysis, sensitive_analysis: SensitiveAnalysis
    ) -> ProtectionStatus:
        """
    ...
    def _generate_combined_recommendations(
        self, hash_analysis: HashAnalysis, sensitive_analysis: SensitiveAnalysis, protection_status: ProtectionStatus
    ) -> List[str]:
        """
    ...
    def _calculate_overall_confidence(self, hash_analysis: HashAnalysis, sensitive_analysis: SensitiveAnalysis) -> float:
        """
