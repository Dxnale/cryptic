...
class TestCrypticAnalyzerIntegration:
    ...
    def test_analyze_sensitive_data_only(self):
        ...
        email_matches = [m for m in analysis.sensitive_analysis.matches 
                        if m.data_type == SensitiveDataType.EMAIL]
    ...
    def test_analyze_critical_sensitive_data(self):
        ...
        rut_matches = [m for m in analysis.sensitive_analysis.matches 
                      if m.data_type == SensitiveDataType.RUT_CHILENO]
    ...
    def test_performance_integration(self):
        ...
        assert analysis.analysis_time_ms < 100, \
            f"Análisis integrado tomó {analysis.analysis_time_ms:.1f}ms (límite: 100ms)"
