...
class TestSensitivePatterns:
    ...
    def test_phone_chile_detection(self):
        ...
        valid_phones = ["+56912345678", "912345678", "22123456", "+56 9 1234 5678", "9 1234 5678", "2 1234 5678"]
        ...
        for phone in valid_phones:
            ...
            phone_matches = [
                ...
                if m.data_type in [SensitiveDataType.PHONE_CHILE, SensitiveDataType.PHONE_INTERNATIONAL]
            ]
    ...
    def test_phone_international_detection(self):
        ...
        for phone in international_phones:
            analysis = self.detector.detect(phone)
            phone_matches = [m for m in analysis.matches if m.data_type == SensitiveDataType.PHONE_INTERNATIONAL]
            assert len(phone_matches) >= 1, f"No se detectó teléfono internacional: {phone}"

    # TESTS PARA IPs
    def test_ip_address_detection(self):
        """Test detección de direcciones IP"""
        valid_ips = ["192.168.1.1", "10.0.0.1", "172.16.0.1", "8.8.8.8", "255.255.255.255"]
    ...
    def test_nombre_false_positives(self):
        ...
        fake_names = ["Lorem Ipsum", "Dolor Sit", "Test User", "John Doe", "Jane Doe"]
    ...
    def test_dni_argentino_detection(self):
        ...
        valid_dnis = ["12.345.678", "1.234.567", "12345678"]
    ...
    def test_ci_uruguayo_detection(self):
        ...
        valid_cis = ["1.234.567-8", "1234567-8"]
...
class TestSensitiveDetectorIntegration:
    ...
    def test_performance_under_100ms(self):
        ...
        """
            * 3
        )  # Triplicar para hacer el texto más largo
    ...
    def test_sensitivity_hierarchy(self):
        ...
        assert analysis.highest_sensitivity == "CRITICAL", f"Nivel de sensibilidad incorrecto: {analysis.highest_sensitivity}"

        # Verificar que hay datos de nivel crítico
        critical_matches = [m for m in analysis.matches if m.pattern_used.sensitivity_level == "CRITICAL"]
    ...
    def test_false_positive_filtering(self):
        ...
        for match in analysis.matches:
            if (
                (match.data_type == SensitiveDataType.EMAIL and "example.com" in match.matched_text)
                or (match.data_type == SensitiveDataType.CREDIT_CARD and "0000" in match.matched_text)
                or (match.data_type == SensitiveDataType.NOMBRE_PERSONA and "John Doe" in match.matched_text)
            ):
...
class TestRecommendationGeneration:
    ...
    def test_critical_data_warnings(self):
        ...
        assert "CRÍTICO" in recommendations_text.upper(), "No se generó advertencia para datos críticos"
